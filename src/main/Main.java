...
public class Main {
	public static void main(String[] args) {
		// Creazione di un oggetto JFrame e import della libreria che ci permette di chiamare le funzioni della classe JFrame che gestisce L'interfaccia grafica con le classi
		...
		window.pack();
		// Metodo che setta la location della finestra, in questo caso abbiamo settato di default (quindi la finestra sarà al centro dello schermo)
